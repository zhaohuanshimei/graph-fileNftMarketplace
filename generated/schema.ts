...
export class ActiveItem extends Entity {
  ...
  get amountListed(): BigInt {
    let value = this.get("amountListed");
    return value!.toBigInt();
  }

  set amountListed(value: BigInt) {
    this.set("amountListed", Value.fromBigInt(value));
  }
  ...
  set amountSold(value: BigInt) {
    this.set("amountSold", Value.fromBigInt(value));
  }
}

export class ItemOwnership extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ItemOwnership entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ItemOwnership must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ItemOwnership", id.toString(), this);
    }
  }

  static load(id: string): ItemOwnership | null {
    return changetype<ItemOwnership | null>(store.get("ItemOwnership", id));
  }
...
export class ItemBought extends Entity {
  ...
  get amountRemain(): BigInt {
    let value = this.get("amountRemain");
    return value!.toBigInt();
  }

  set amountRemain(value: BigInt) {
    this.set("amountRemain", Value.fromBigInt(value));
  }
}

export class ItemSoldOut extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ItemSoldOut entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ItemSoldOut must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ItemSoldOut", id.toString(), this);
    }
  }

  static load(id: string): ItemSoldOut | null {
    return changetype<ItemSoldOut | null>(store.get("ItemSoldOut", id));
  }
